...
export const navItems = [
  ...
  { href: "/import-center", label: "Import Center" },
  { href: "/seed-center", label: "Seed Center" },
  { href: "/staging-review", label: "Staging Review" },
  { href: "/textchunk-studio", label: "TextChunk Studio" },
  { href: "/controversial-claim-studio", label: "Controversial Claim Studio" },
  { href: "/research-task-board", label: "Research Task Board" },
  { href: "/review", label: "Review Workbench" },
  { href: "/rankings", label: "Rankings" },
  { href: "/alternative-narrative", label: "Alternative Narrative" },
